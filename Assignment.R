...
features<-read.table("/Users/crios93/curso/UCI HAR Dataset/features.txt", col.names = c("n","functions"))
activities<-read.table("/Users/crios93/curso/UCI HAR Dataset/activity_labels.txt", col.names = c("code","activity"))

subjecttrain<-read.table("/Users/crios93/curso/UCI HAR Dataset/train/subject_train.txt", col.names = "subject")
trainx<-read.table("/Users/crios93/curso/UCI HAR Dataset/train/X_train.txt", col.names = features$functions)
trainy<-read.table("/Users/crios93/curso/UCI HAR Dataset/train/Y_train.txt", col.names ="code" )
subjecttest<-read.table("/Users/crios93/curso/UCI HAR Dataset/test/subject_test.txt", col.names = "subject")
testx<-read.table("/Users/crios93/curso/UCI HAR Dataset/test/X_test.txt", col.names = features$functions)
testy<-read.table("/Users/crios93/curso/UCI HAR Dataset/test/Y_test.txt", col.names = "code")
